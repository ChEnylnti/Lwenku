<%@ page import="com.hbnu.Lwenku.model.Hon" %>
<%@ page import="com.hbnu.Lwenku.dao.HonDao" %>
...
<body>
<%
    List<Hon> all=new HonDao().orderByRecommend();
            ...
            <div class="block">
                ...
                <div class="blockcontent">
                    <div style="padding-left: 10px">
                        <ul class="ulrow">
                            <li>
                                欢迎回来，<strong> ${sessionScope.now.username}</strong>
                            </li>
                        </ul>
        ...
        <div class="col-md-9">
            <div class="centerm">
                <table width="100%" align="center" class="grid">
                    <caption>推荐的小说
                        <c:if test="${sessionScope.now.roles[0].id==1}">
                            ...
                            <c:forEach items="${all}" var="hon">
                                <div style="width: 373px;float: left;margin: 5px 0px 5px 5px">
                                    ...
                                    <div style="margin-top: 5px">
                                        ...
                                        <p style="margin-bottom: 0px;margin-top: -0px;">推荐指数：${hon.recommend}</p>
                                        <c:if test="${sessionScope.now.roles[0].id==1}">
                                        <a href="${pageContext.request.contextPath}/BookServlet?dowhat=update&name=${hon.name}">修改</a>
                                        <a href="${pageContext.request.contextPath}/BookServlet?dowhat=del&id=${hon.id}">删除</a>
                                        </c:if>
                                        <a href="${pageContext.request.contextPath}/BookServlet?dowhat=recommend&name=${hon.name}">推荐一下</a>
                                    </div>
                                </div>
                            </c:forEach>
                        </td>
